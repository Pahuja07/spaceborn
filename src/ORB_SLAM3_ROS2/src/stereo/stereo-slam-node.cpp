    ...
    m_SLAM(pSLAM)
{
    ...
    left_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "camera/left", rmw_qos_profile_sensor_data);
    right_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "camera/right", rmw_qos_profile_sensor_data);
